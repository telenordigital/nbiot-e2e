...
func (FieldType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5f3db3d7290e3af9, []int{0}
}
...
func (IntSize) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5f3db3d7290e3af9, []int{1}
}
...
func (m *NanoPBOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NanoPBOptions.Unmarshal(m, b)
}
...
func (m *NanoPBOptions) XXX_Size() int {
	return xxx_messageInfo_NanoPBOptions.Size(m)
}
...
func init() {
	proto.RegisterFile("nanopb/generator/proto/nanopb.proto", fileDescriptor_5f3db3d7290e3af9)
}

var fileDescriptor_5f3db3d7290e3af9 = []byte{
